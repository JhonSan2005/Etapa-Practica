<?php 
    ...
    $session_activa = isset($_SESSION['id']);
?>
...
<div class="container d-flex justify-content-center align-items-center" style="margin-top: 100px;">
    ...
    <?php else: ?>
        <div class="text-center">
            <h3 id="mensaje-rotativo" class="text-primary"></h3>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                let index = 0;
                const mensajeRotativo = document.getElementById("mensaje-rotativo");

                if (mensajeRotativo) {
                    mensajeRotativo.textContent = mensajes[index];
                    setInterval(() => {
